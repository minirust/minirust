...
/// In this test the next block of the `call` does not exists, which results in an ill-formed program.
#[test]
...
/// In this test the nunwind block of the `call` does not exists, which results in an ill-formed program.
#[test]
