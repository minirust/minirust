        ...
        match (value, ty) {
            ...
            (Value::Ptr(ptr), Type::Ptr(ptr_ty)) => {
                ...
                if let Some(pointee) = ptr_ty.safe_pointee() {
                    ...
                    ensure_ub(align.is_aligned(ptr.thin_pointer.addr), "Value::Ptr: unaligned safe pointer")?;
                    ensure_ub(pointee.inhabited, "Value::Ptr: safe pointer to uninhabited type")?;
                    ensure_ub(
